...
__all__ = ["load_cityscapes_voc_instances", "register_cityscapes_voc"]


# fmt: off
CLASS_NAMES = ( 'person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle', 'bicycle')

def load_cityscapes_voc_instances(dirname: str, split: str, class_names: Union[List[str], Tuple[str, ...]]):
    """
